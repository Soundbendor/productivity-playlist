...
scores = [algos.euclidean_score, algos.manhattan_score, algos.mult_score, algos.rand_score]
key = ["Euclidean Distance", "Manhattan Distance", "Multiplied Ratios", "Random Neighbors"]
smoothnesses = []
